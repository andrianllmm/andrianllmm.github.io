---
title: "Proving Custom Data Structures Actually Work"
description: "Writing a priority queue, binary tree, and hash map from scratch is easy to get subtly wrong, so ZipZap puts them to the test by building a working Huffman-coding file compressor around them."
date: "2025-12"
image: "./preview.png"
---
