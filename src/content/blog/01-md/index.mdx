...
<div class="text-muted-foreground bg-muted my-2 w-full rounded">
  This is a muted background for the headings section.
</div>

<div class="text-accent-foreground bg-accent my-2 w-full rounded">
  This is a accent background for the headings section.
</div>
...
<Callout type="warning">
  Use the `prettier-ignore` comment to prevent the code block from being
  formatted by Prettier. This is useful for keeping the Markdown syntax
  readable.
</Callout>
