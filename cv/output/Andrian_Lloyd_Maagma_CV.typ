...
#one-col-entry(
  content: [A Computer Science student who builds full-stack apps with machine learning. I aim to create tools that people actually use and find useful. I also value accessible software and contribute to open-source whenever I can.]
)
...
#v(design-entries-vertical-space-between-entries)
#one-col-entry(
  content: [#strong[Languages:] English \(Professional working proficiency\), Tagalog \(Professional working proficiency\)]
)
